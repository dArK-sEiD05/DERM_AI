...
import { validateUserJWTToken } from '../api'; // Replace 'your-authentication-module' with the actual module path
import { setUserDetails } from "../context/actions/userActions"; // Replace 'your-redux-actions' with the actual actions module path
  ...
  return (<div className='login relative overflow-hidden flex w-screen h-screen'>
    ...
    <div className="bgleft items-center h-full  w-[35%] md:w-508 z-10 backdrop-blur-md p-4 px-4 py-12">
      <div className="flex items-center justify-start gap-4 w-full">
        ...
        <p className="text-black font-semibold text-2xl">DermAI</p>
      </div>
      <br></br>
